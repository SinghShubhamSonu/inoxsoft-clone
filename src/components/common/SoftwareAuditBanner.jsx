        ...
        <div className="container mx-auto px-4">
          <div className="text-center text-white">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              GET A FULL SOFTWARE AUDIT TO SPOT RISKS EARLY
            </h2>
            <p className="text-lg max-w-2xl mx-auto mb-12">
              Uncover hidden issues, boost performance, and reduce costs with a 
              technical audit. Watch our CTO explain why it matters.
            </p>
            <div className="flex justify-center">
              <div className="relative inline-block">
                ...
                >
                  <span className="relative z-10 text-[18px]">EXPLORE  <i className="fa fa-angle-right ml-2 relative z-10"></i></span>
                  <span
...
export default SoftwareAuditBanner;