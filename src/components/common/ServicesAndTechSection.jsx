...
const InoxoftServicesTechSection = () => {
    ...
    <section className="py-12 bg-white">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="flex border-b border-gray-200 mb-12">
          <div 
            className={`cursor-pointer py-4 px-8 font-semibold text-xl ${activeTab === 'services' ? 'text-blue-800 border-b-2 border-blue-800' : 'text-gray-500'}`}
            onClick={() => setActiveTab('services')}
          >
            Services
          </div>
          <div 
            className={`cursor-pointer py-4 px-8 font-semibold text-xl ${activeTab === 'tech' ? 'text-blue-800 border-b-2 border-blue-800' : 'text-gray-500'}`}
          ...
          <div className="w-full">
            ...
            <div className="flex flex-col lg:flex-row mb-6">
              ...
              <div className="w-full lg:w-1/2 pr-0 lg:pr-6 mb-6 lg:mb-0">
                <h2 className="text-3xl font-bold text-blue-900 mb-6">SOFTWARE DEVELOPMENT SERVICES</h2>
        ...
        {activeTab === 'tech' && (
          <div className="w-full">
            ...
            <div className="flex flex-col lg:flex-row mb-6">
              {/* Left side content */}
              <div className="w-full lg:w-1/2 pr-0 lg:pr-6 mb-6 lg:mb-0">
                <h2 className="text-3xl font-bold text-blue-900 mb-6">THE TECHNOLOGY PLATFORMS WE USE</h2>
                <p className="text-gray-700">
...
export default InoxoftServicesTechSection;