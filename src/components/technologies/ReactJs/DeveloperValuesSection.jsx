  ...
  const cardsData = [
    {
      ...
      text: 'With 98% of our team being senior and mid-level engineers, we bring specialized knowledge and problem-solving skills to every project. Our certified React engineers are ready to tackle even the toughest challenges.'
    },
    {
      title: 'Guided by Core Values',
      text: 'We believe in constant improvement, meaningful partnerships, and putting your goals front and center. For us, its not just about the end product – its about creating real value for your business and the people you serve.'
    },
    {
      title: 'Flexible Pricing',
      text: 'Our flexible pricing options are built around your needs, providing cost control and alignment with your goals. We make sure you only pay for what adds value, helping you manage costs without compromising quality.'
    },
    {
      title: 'Scalable Team Solutions',
      text: 'Need to scale fast? With a network of 170+ skilled professionals, Inoxoft makes it simple to expand your team and bridge any technical gaps as your project demands.'
    }
  ];
    ...
    <section className="py-24 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-2xl md:text-3xl font-bold text-[#003349] uppercase">
            WHY HIRE REACT.JS DEVELOPERS FROM <br className="hidden md:block" /> OUR TEAM
          </h2>
        </div>
