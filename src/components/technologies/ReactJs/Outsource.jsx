      ...
      <div className="max-w-full overflow-hidden mt-27"> {/* Prevent overflow */}
        <div className="text-left px-4 sm:px-8 md:px-20">
          ...
          <p className="text-white mb-4 text-lg sm:text-xl md:text-2xl pt-5 pr-0 md:pr-6 leading-7 md:leading-9">
            Outsource React development to support your team at any 
            project stage. Enjoy faster project delivery, reduced hiring costs,
            and more time to focus on growth and brand-building while we
            handle candidate screening and hiring for you.
          </p>
