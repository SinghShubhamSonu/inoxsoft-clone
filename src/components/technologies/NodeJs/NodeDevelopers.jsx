  ...
  const cardsData = [
    {
      ...
      text: 'With 98% of our team made up of senior and mid-level engineers, we focus on building deep expertise. Our clients work with certified Node.js engineers ready to solve tough challenges.'
    },
    {
      title: '100% Customer Satisfaction',
      text: 'Our 5/5 rating on Clutch, backed by reviews from over 200 clients worldwide, reflects our commitment to quality. We’re proud to have earned the trust of clients from Toronto to Tokyo.'
    },
    {
      title: 'Flexible Team Expansion',
      text: 'Inoxoft has over 170 software experts available to meet our partner needs, making it easy to quickly scale teams to fill any technical gaps with the best Node.js experts.'
    },
    {
      title: 'Values-Driven Work',
      text: 'Our work centers on continuous improvement, genuine care, and a deep understanding of each client’s goals. We don’t just build products; we build them with a focus on value and a clear understanding of how our work impacts you and your clients.'
    }
  ];
  ...
  return (
    <section className="py-24 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-start pl-10 mb-12">
          <h2 className="text-2xl md:text-4xl font-bold text-[#003349] uppercase">
          WHY HIRE OUR NODE.JS EXPERTS 
          </h2>
        </div>
