      ...
      >
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl md:text-2xl font-bold mb-10">
            Need expert developers or project support?<br/>
            ...
            <div className="flex justify-center">
              <div className="relative inline-block">
                ...
                >
                  <span className="relative z-10 text-[18px]">Let's TALK  <i className="fa fa-angle-right ml-2 relative z-10"></i></span>
                  <span
