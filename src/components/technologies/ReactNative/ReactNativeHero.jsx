...
const ReactNativeHero = () => {
    ...
    // Button animation handlers (copied from OutsourceButton)
  ...
  // Partner logos - using the same structure as outsource.jsx
  const images = [
  ...
  return (
    <section className="h-full mt-4 bg-cover bg-center bg-no-repeat  bg-[url('https://inoxoft.com/wp-content/webp-express/webp-images/uploads/2020/03/Frame-8644-7.jpg.webp')] xl:bg-[url('https://inoxoft.com/wp-content/webp-express/webp-images/uploads/2020/03/image-40-12.jpg.webp')]">
      <div className="max-w-full overflow-hidden mt-27">
        <div className="text-left px-4 sm:px-8 md:px-20">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-4 text-white pt-14 mt-4">
            REACT NATIVE APPLICATION<br className="hidden sm:block" />DEVELOPMENT SERVICES
          </h1>

          <p className="text-white mb-4 text-xl sm:text-2xl md:text-3xl pt-5 pr-0 md:pr-6 leading-7 md:leading-9">
            Though being a relatively new technology, React Native has earned a positive reputation among <br/>the other popular frameworks. Allowing hybrid app development, it offers many advantages besides that.
          </p>

          <div className=' mt-20 '>
            {/* Updated button with animation matching OutsourceButton */}
        ...
        {/* Carousel Section - following the pattern from outsource.jsx */}
