  ...
  const cardsData = [
    {
        ...
        text: 'With 98% of our team being senior and mid-level engineers, we bring deep backend expertise and architectural precision to every project. Our certified Spring Boot developers excel at building robust, scalable, and secure applications.'
    },
    {
        title: 'Guided by Core Values',
        text: 'We focus on long-term value, continuous improvement, and strong client relationships. It’s not just about building software – it’s about aligning backend systems with your business goals for maximum impact.'
    },
    {
        title: 'Flexible Pricing',
        text: 'Our pricing models are built to fit projects of all sizes – whether you\'re launching an MVP or scaling an enterprise system. Pay only for the functionality and engineering effort that delivers real value.'
      },
      {
        title: 'Scalable Team Solutions',
        text: 'Need to grow quickly? With a network of 170+ backend professionals, we can expand your Spring Boot development team seamlessly, helping you stay on schedule and maintain quality at every stage.'
      }
  ];
    ...
    <section className="py-24 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <h2 className="text-3xl md:text-3xl font-bold text-[#003349] uppercase">
            WHY HIRE SPRING BOOT DEVELOPERS FROM <br className="hidden md:block" /> OUR TEAM
        </h2>
