      ...
      <div className="max-w-full overflow-hidden mt-27"> {/* Prevent overflow */}
        <div className="text-left px-4 sm:px-8 md:px-20">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-4 text-white pt-14 mt-4">
            OUTSOURCE SPRING BOOT DEVELOPMENT SERVICES
          </h1>

          <p className="text-white mb-4 text-lg sm:text-xl md:text-2xl pt-5 pr-0 md:pr-6 leading-7 md:leading-9">
          Outsource Spring Boot development to support your team at any stage of the project 
          lifecycle. Achieve faster delivery timelines, lower hiring costs, and more time to focus on 
          scaling your business and enhancing your brand—while we take care of candidate 
          screening and hiring for you.
          </p>
