  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        Is your project lacking skilled HTML, CSS, and JavaScript developers?<br />
        Let’s discuss how we can assist you in building robust, high-performance front-end solutions that drive your business forward.
        </p>
          ...
          <div className="relative inline-block">
            ...
            >
              <span className="relative z-10 hover:text-white text-[18px] ">
                DROP US A LINE <i className="fa fa-angle-right ml-2 relative z-10"></i>
              </span>
