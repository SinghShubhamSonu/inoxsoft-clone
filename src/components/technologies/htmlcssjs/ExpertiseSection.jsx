        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-12">
          ...
          <div className="lg:w-1/2 lg:pl-8">
            <ul className="space-y-4">
              {[
           'HTML/CSS/JS Website Design & Optimization',
            'Front-end API Development & Integration',
            'UI/UX Security & User Authentication',
            'Front-end Performance Optimization & Tuning',
            'Web Architecture for Single-Page Applications (SPAs)',
            'Front-end Automation & CI/CD Tools (Jenkins, Docker)',
              ].map((item, index) => (
