    ...
    <section className="h-full mt-4 bg-cover bg-center bg-no-repeat bg-[url('https://inoxoft.com/wp-content/webp-express/webp-images/uploads/2020/03/Frame-8644-7.jpg.webp')] xl:bg-[url('/src/assets/images/outsource-bg.jpg')]">
      <div className="max-w-full overflow-hidden mt-27"> {/* Prevent overflow */}
        <div className="text-left px-4 sm:px-8 md:px-20">
          ...
          OUTSOURCE HTML/CSS/JS DEVELOPMENT SERVICES
          </h1>

          <p className="text-white mb-4 text-lg sm:text-xl md:text-2xl pt-5 pr-0 md:pr-6 leading-7 md:leading-9">
          Outsource your HTML, CSS, and JavaScript development needs to strengthen your team at every stage of your project lifecycle. By leveraging our expertise, you can speed up project delivery, reduce hiring costs, and focus on scaling your business. We take care of candidate screening, selection, and hiring, allowing you to focus on enhancing your brand while we provide high-quality front-end solutions tailored to your needs.
          </p>
