  ...
  const cardsData = [
    {
        ...
        text: 'With 98% of our team being senior and mid-level engineers, we bring deep backend expertise and architectural precision to every project. Our certified PHP developers specialize in creating robust, scalable, and secure web applications using frameworks like Laravel and Symfony.'
      },
      {
        title: 'Guided by Core Values',
        text: 'We focus on long-term value, continuous improvement, and strong client relationships. It’s not just about coding – it’s about aligning your PHP backend systems with business goals for measurable results.'
      },
      {
        title: 'Flexible Pricing',
        text: 'Our pricing models are designed to support everything from MVPs to large-scale enterprise platforms. You only pay for the features and engineering effort that bring actual business value.'
      },
      {
        title: 'Scalable Team Solutions',
        text: 'Looking to scale fast? With a network of 170+ backend professionals, we can grow your PHP development team on demand, helping you accelerate delivery without compromising on quality.'
      }
  ...
  return (
    <section className="py-24 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <h2 className="text-3xl md:text-3xl font-bold text-[#003349] uppercase">
            WHY HIRE PHP DEVELOPERS FROM <br className="hidden md:block" /> OUR TEAM
        </h2>
