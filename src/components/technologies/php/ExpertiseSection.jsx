        ...
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-12">
          ...
          <div className="lg:w-1/2 lg:pl-8">
            <ul className="space-y-4">
              {[
          'Core PHP & Modern PHP Frameworks (Laravel, Symfony)',
          'RESTful API Development with PHP',
          'Authentication & Authorization (JWT, OAuth2, Laravel Sanctum/Passport)',
          'ORM & Database Integration (Eloquent ORM, Doctrine)',
          'Modular Architecture & Microservices with PHP',
          'Composer & CI/CD Tools (GitHub Actions, Docker, Jenkins)'
              ].map((item, index) => (
