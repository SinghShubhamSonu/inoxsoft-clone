      ...
      <div className="max-w-full overflow-hidden mt-27"> {/* Prevent overflow */}
        <div className="text-left px-4 sm:px-8 md:px-20">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-4 text-white pt-14 mt-4">
            OUTSOURCE SQL DEVELOPMENT SERVICES
          </h1>

          <p className="text-white mb-4 text-lg sm:text-xl md:text-2xl pt-5 pr-0 md:pr-6 leading-7 md:leading-9">
          Outsource SQL development to strengthen your team at every phase of your project lifecycle. By leveraging our expertise, you can accelerate project timelines, reduce hiring expenses, and focus on scaling your business. We handle the candidate screening, selection, and hiring process, so you can focus on improving your brand while we deliver high-quality SQL solutions tailored to your needs.
          </p>
