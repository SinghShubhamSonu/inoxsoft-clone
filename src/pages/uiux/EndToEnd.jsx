  ...
  const cardsData = [
    {
      ...
      text: 'Our responsive UI/UX design services are tailored specifically to meet the needs and expectations of your target audience. We start with a deep understanding of your target audience to create apps that are easy to use, efficient, and engaging.'
    },
    {
      title: 'Mobile-First Design',
      text: 'Inoxoft is committed to delivering exceptional UI and UX design services. We ensure that your digital product seamlessly adapts to different platforms and brings an enjoyable experience for users, whether they’re on a desktop, tablet, or mobile device.'
    },
    {
      title: 'Functional Design',
      text: 'We believe that exceptional design goes beyond aesthetics. Our design team creates stunning interfaces that are both visually appealing and easy to use, with each element being carefully crafted and rigorously tested throughout all UI/UX design services.'
    },
    {
      title: 'Continuous Improvement',
      text: 'Our team follows an iterative design approach, by constantly improving our designs based on user feedback and testing results. We guarantee with our UI/UX website and mobile app design services that your solution keeps your users engaged and coming back for more.'
    }
  ];
