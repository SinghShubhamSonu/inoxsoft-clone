  ...
  const industries = [
    {
        ...
        services: [
          "We’ve helped clients enhance their online presence and streamline logistics operations with innovative website solutions:",
          "User-friendly Web Portals for Fleet Management",
          "Real-time Shipment Tracking and Updates",
          "Responsive Design for Seamless Mobile Access",
          "E-commerce Integration for Supply Chain Solutions"
        ],
        featured: true
      },
      {
        ...
        services: [
          "Our expertise in website development for healthcare has empowered providers to enhance patient engagement and streamline care:",
          "Accessible Patient Portals and Scheduling Systems",
          "Telemedicine Platforms for Virtual Consultations",
          "Responsive, HIPAA-compliant Websites",
          "Patient Education and Resource Centers"
        ],
        featured: true
      },
      {
        ...
        services: [
          "Drawing on our experience in educational technology, we’ve crafted websites to elevate the learning experience:",
          "Interactive eLearning Platforms",
          "Student and Course Management Systems",
          "Customizable Content Management Systems (CMS)",
          "Responsive Designs for Accessible Learning"
        ],
        featured: true
      },
      {
        ...
        services: [
          "Our expertise in website development for financial services has helped clients build secure and transparent online platforms:",
          "User-friendly Online Banking and Transaction Systems",
          "Integrated Payment Gateways",
          "Custom Investment and Portfolio Management Tools",
          "Secure, Scalable Websites with Robust Data Encryption"
        ],
        featured: false
      },
      {
        ...
        services: [
          "With a focus on digital transformation, we’ve developed websites that have reshaped the real estate industry:",
          "Advanced Property Search and Listings",
          "Virtual Tours and Immersive Property Experiences",
          "Agent and Property Management Solutions",
    ...
    <section className="py-16 bg-white relative">
      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="text-start mb-16">
          <h2 className="text-4xl font-bold text-[#173753] mb-6">INDUSTRIES OUR  WEBSITE <br/>DEVELOPMENT AGENCY EXCELS IN</h2>
          {/* <p className="text-gray-700 text-[18px] max-w-3xl mx-auto">
            Our experienced developers have worked in many industries, gaining valuable skills along the way. 
            Each sector has its own needs, and we're dedicated to building solutions that fit. 
            Here's a look at the industries we provide our custom React.js development services to:
          </p> */}
        </div>
