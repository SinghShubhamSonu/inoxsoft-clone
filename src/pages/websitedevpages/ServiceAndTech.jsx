...
const ServiceAndTech = () => {
  ...
  const techStack = [
    ...
    },
    {
      ...
      description: "Codethics Solutions is a python web and mobile development company. We offer high-quality web solutions in this programming language."
    },
    {
      title: ".Net Development Services",
      image: Tech3,
      link: "/technologies/net-core/",
      description: "Codethics Solutions projects are mostly based on .NET and having realized 80 software solutions."
    },
    {
          ...
          <div className="w-full">
            ...
            <div className="flex flex-col lg:flex-row mb-6">
              ...
              <div className="w-full lg:w-1/2 pr-0 lg:pr-6 mb-6 lg:mb-0">
                <h2 className="text-3xl font-bold text-[#173753] mb-6">SOFTWARE DEVELOPMENT SERVICES</h2>
