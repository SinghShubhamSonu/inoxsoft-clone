...
const OurSuccess = () => {
  ...
  const successCases = [
    {
      title: "SaaS platform and mobile application for waste management startup ",
      description: "SaaS platform and mobile application for waste management startup ",
      location: "Australia",
    ...
    },
    {
      ...
      technologies: "React Native, AngularJS , AZure",
      image: "https://inoxoft.com/wp-content/uploads/2023/05/image-15.webp",
      screenshot: "/images/proof-app-screenshot.png"
    },
    {
        title: "Web and Mobile Solutions For HR Management on Construction Sites",
        description: "How we built a comprehensive HR management platform to streamline construction workforce operations and drive cost savings.",
        location: "United Kingdom",
        industries: "Human Resources",
        services: "Mobile Application Development, Web Development",
        technologies: "React Native, AWS, PHP. Laravel, VueJS",
        image: "https://inoxoft.com/wp-content/themes/inoxoft/images/case-studies/macbook_new-min.webp",
        screenshot: "/images/hr-management-screenshot.png" // Replace with appropriate screenshot URL if available
      }
    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center mb-10">
          <h2 className="text-3xl font-bold text-[#00283b] ml-2"> SUCCESS CASES</h2>
