  ...
  const industries = [
    {
      ...
      services: [
       "We help with gathering data for better performance, real-time fleet management, vehicle tracking, barcode scanning, and all kinds of systems for safe and improved supply chain services."
      ],
      featured: true
    },
    {
      ...
      services: [
        "Inoxoft offers custom healthcare solutions done by high-skilled professionals with considerable domain expertise. We’ve delivered top-notch medical software for a range of medical service institutions."
      ],
      featured: true
    },
    {
      ...
      services: [
        "We’ll help you empower teachers and students with software, made with the latest technologies and best practices, to make the engagement in the learning process supercharged with powerful features."
      ],
      featured: true
    },
    {
      title: "Finance Software Development",
      image: 'https://inoxoft.com/wp-content/webp-express/webp-images/uploads/2024/06/Main-cards-Services-2.png.webp',
      link: "/industries/fintech/",
      services: [
        "Inoxoft provides fintech software development services for businesses to resolve their automation challenges, leverage trading success, and digitizing banking services."
      ],
      featured: true
    },
    {
      ...
      services: [
        "Drive smarter decisions with our custom software development for the real estate industry. Our tech-driven software tools will create real estate software development solutions for your competitive edge."
      ],
      featured: true
    },
    {
        title: "Blockchain Software Development",
        image: 'https://inoxoft.com/wp-content/webp-express/webp-images/uploads/2024/07/Top_icon.jpg.webp',
        link: "/industries/custom-real-estate-software-development-services/",
        services: [
          "Multiple Listing Service (MLS) Software Property Rental Management Software Homeowners’ Association (HOA) Management Software"
        ],
        featured: true
      }
  ];
    ...
    <section className="py-16 bg-white relative">
      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="text-start mb-16">
          <h2 className="text-4xl font-bold text-[#173753] mb-6">MVP DEVELOPMENT SERVICES FOR DIVERSE<br/> INDUSTRIES</h2>
          <p className="text-gray-700 text-[18px] max-w-3xl ">
          Inoxoft has extensive experience in MVP development across various industries, enabling us to tailor MVP development services to meet the unique needs of each sector. We have a proven track record of delivering successful MVPs for clients in various domains, including:
          </p>
        </div>
