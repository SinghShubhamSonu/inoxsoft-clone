  ...
  const industries = [
    {
      ...
      services: [
        "We’ve helped clients optimize their supply chains and elevate customer satisfaction with innovative solutions:",
        "Efficient Routing and Fleet Management",
    ...
    },
    {
      ...
      services: [
        "Our experience in healthcare software development has empowered providers with:",
        "Accessible Care through Telemedicine",
    ...
    },
    {
      ...
      services: [
        "Drawing on our experience in educational technology, we’ve developed innovative solutions to revolutionize learning:",
    ...
    },
    {
      ...
      services: [
        "Our expertise in financial technology has enabled us to create secure and user-friendly applications:",
    ...
    },
    {
      ...
      services: [
        "With a focus on digital innovation, we’ve transformed the real estate industry with our software solutions:",
    ...
    <section className="py-16 bg-white relative">
      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="text-start mb-16">
          <h2 className="text-4xl font-bold text-[#173753] mb-6">INDUSTRIES OUR SOFTWARE PRODUCT <br/>DEVELOPMENT AGENCY EXCELS IN</h2>
