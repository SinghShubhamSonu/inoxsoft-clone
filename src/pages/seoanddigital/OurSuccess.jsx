...
const OurSuccess = () => {
  ...
  const successCases = [
    {
      title: "SEO and Content Strategy for Enhanced Online Visibility",
      description: "How we helped a UK-based brand improve its online presence and drive organic traffic through targeted SEO and content strategies.",
      location: "United Kingdom",
      industries: "Digital Marketing",
      services: "SEO Strategy, Content Creation, Analytics",
      technologies: "Google Analytics, SEMrush, Moz, WordPress, Yoast SEO, Google Search Console",
      image: "https://inoxoft.com/wp-content/themes/inoxoft/images/case-studies/macbook_new-min.webp",
      screenshot: "/images/seo-strategy-screenshot.png"
    },
    {
      title: "PPC Campaigns for E-Commerce Growth",
      description: "How we helped a Canadian e-commerce store scale up sales through highly optimized pay-per-click (PPC) campaigns, improving ROI.",
      location: "Canada",
      industries: "E-Commerce",
      services: "PPC Advertising, Campaign Management, Performance Analytics",
      technologies: "Google Ads, Facebook Ads, Bing Ads, Google Analytics, Optmyzr",
      image: "https://inoxoft.com/wp-content/themes/inoxoft/images/case-studies/macbook_new-min.webp",
      screenshot: "/images/ppc-campaign-screenshot.png"
    },
    {
      title: "Social Media Marketing for Brand Awareness",
      description: "How we helped a US-based startup boost brand awareness and engagement across multiple social media platforms, driving customer loyalty and increasing conversion rates.",
      location: "United States",
      industries: "Technology",
      services: "Social Media Strategy, Content Marketing, Analytics",
      technologies: "Facebook, Instagram, LinkedIn, Hootsuite, Buffer, Google Analytics",
      image: "https://inoxoft.com/wp-content/themes/inoxoft/images/case-studies/macbook_new-min.webp",
      screenshot: "/images/social-media-screenshot.png"
    },
  ];
