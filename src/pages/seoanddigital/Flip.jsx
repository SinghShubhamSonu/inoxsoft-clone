...
const Flip = () => {
  ...
  const cardsData = [
    {
      title:"Innovative SEO & Marketing Solutions",  
      text: "We focus on driving organic growth, increasing visibility, and delivering user-centric digital marketing solutions. Our expert team combines SEO proficiency with market insights to bring your brand’s vision to life, ensuring it attracts the right audience and achieves business objectives."
    },
    {
      title: "End-to-End Digital Marketing Services",
      text: "We take full responsibility for your digital marketing journey. From strategy and content creation to paid ads and performance analysis, we collaborate closely with you to define the right approach, select the best tools and technologies, and guide your campaigns from start to finish."
    },
    {
      title: "Proactive Campaign Management",
      text: "We provide continuous oversight of your digital marketing campaigns, tracking performance and ensuring alignment with your business goals. With our proactive approach, we ensure that every campaign stays on track, meets deadlines, and delivers measurable results."
    },
    {
      title: "Your Trusted Digital Marketing Partner",
      text: "We are committed to your business success and dedicated to bringing your marketing vision to life. With our comprehensive services, strategic approach, and hands-on campaign management, you can focus on your core business while we handle all aspects of your digital marketing."
    }
  ];
    ...
    <section className="py-24 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-start mb-12">
          ...
          Why Inoxoft for SEO and Digital <br /> Marketing Services? <br className='hidden md:block' />
          </h2>
        </div>
